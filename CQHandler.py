...
levelTable = ["����", "����", "����", "��", "�ٹ�", "ԪӤ", "����", "����", "���", "�ɽ�", "����"]
subLevelTable = ["һ��", "����", "����", "�Ĳ�", "���", "����", "�߲�", "�˲�", "�Ų�", "Բ��"]
drawLimitTable = [1,3,6,10,15,20,30,40,50,60,80,110]
invokerSkillIndex = [0, 3, 5, 7, 9, 11, 13, 15, 19, 21, 27]
audioTable = {
    'aya': 'Chatwheel_ay_ay_ay.wav',
    '��ѽѽѽѽ': 'Chatwheel_ay_ay_ay.wav',
    'ehtogg': 'Chatwheel_ehto_g_g.wav',
    '��զ����': 'Chatwheel_ehto_g_g.wav',
    'patience from zhou': 'Chatwheel_patience.wav',
    '����': 'Chatwheel_patience.wav',
    '���': 'Chatwheel_eto_prosto_netchto.wav',
    'brutal': 'Chatwheel_brutal.wav',
    'Ұ��': 'Chatwheel_brutal.wav',
    '����': 'Chatwheel_jia_you.wav',
    '�治����': 'Chatwheel_wan_bu_liao_la.wav',
    '���': 'Chatwheel_tian_huo.wav',
    '�ߺò���': 'Chatwheel_zou_hao_bu_song.wav',
    '����·���ô�': 'Chatwheel_po_liang_lu.wav',
    '��������˹': 'Chatwheel_universe.wav',
    'universe': 'Chatwheel_universe.wav'
}

sourcePath = 'F:/��Q Pro/data/image/'
audioPath = 'F:/��Q Pro/data/record/'
imagePath = 'F:/��Q Pro/data/image/comic/'
...
class CQHandler(object):
    ...
    def authority(self, fromGroup, QQID):
        if QQID in self.adminList:
            ...
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '����Ȩ���д˲���' )
            return False
    ...
    def addBanword(self, fromGroup, QQID, word):
        if self.authority(fromGroup, QQID):
            ...
            try:
                CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + "֪���ˣ��һ�����" + str(word) + "��")
            except Exception as e:
                logging.exception(e)
    ...
    def calc(self, fromGroup, QQID, inpt):
        ...
        if result:
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '����ǣ�' + str(result))
            if img:
                logging.info("???")
    ...
    def invoker(self, fromGroup, QQID, para=None):
        ...
        if para is None:
            ...
            if len(para) != 3:
                CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + 'ʩ�����ִ���')
            ...
            if pat.match(para):
                ...
                CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '����ǻ���')
                self.invokerFail(fromGroup)
                return
        try:
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '�ͷ���' + skillName)
    ...
    def drawQuery(self, fromGroup, QQID):
        ...
        CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '\nÿ�ճ鿨������' + str(member.drawLimit) + '\n�������ô�����' + str(member.drawTimes) + '\nʣ����ô�����' + str(remainingDrawTimes))
    ...
    def draw(self, fromGroup, QQID, para):
        ...
        if member.drawTimes >= member.drawLimit:
            try:
                CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '��봽���鿨��')
            except Exception as e:
                return
        else:
            para = para.lower()
            if 'x' in para:
                ...
                if key is None:
                    logging.info("f0")
                    CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + 'û�д˿���' + str(key))
                    return
                if not times.isdigit() or int(times) <= 0:
                    CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '�鿨��������')
                    return
                times = int(times)
                if times > 10:
                    times = 10
                ...
                if result is not None:
                    ...
                    if remainingDrawTimes == 0:
                        ...
                        retInfo = '����ջ���' + str(remainingDrawTimes) + '�γ鿨����'
                    retCards = ''
                    for card in result:
                    ...
                    CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '�����������ʧ����')
    ...
    def learnBface(self, fromGroup, QQID, para):
        ...
        if self.check_keywords(key):
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '���ᣬȺ���ﲻѧ%>_<%')
            return
        ...
        if value == '':
            ...
            return
        if value.find('\n') == 1 or len(value) > 500:
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '���̫���ˣ�Ⱥ����ѧ����T_T')
            return
        # image
        url = ''
        logging.info("f1")
        ...
        try:
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '֪����!' + str(key) + '->' + value)
        except Exception as e:
            logging.exception(e)
    ...
    def forget(self, fromGroup, QQID, para):
        ...
        if self.bfaceMap.has_key(key):
            ...
            retMsg = str(CQAt(QQID)) + str(key) + '�������ʲô��?_?�����Ѿ��ǲ��������(�����ɹ�!)'
        else:
            retMsg = str(CQAt(QQID)) + '�һ�ûѧ�������ѽ( �� o �� )��'
        try:
    ...
    def roll(self, fromGroup, QQID, para=None):
        ...
        member.rollNum += 1
        try:
            CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '������' + str(result) + '\n')
        except Exception as e:
            logging.exception(e)
    ...
    def speak(self, fromGroup, QQID, tag=None):
        ...
        if tag is not None and tag != '':
            ...
            if findTag == False:
                try:
                    CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + '������л�û�������Դ%>_<%')
                except Exception as e:
                    logging.exception(e)
                return
        else:
    ...
    def tagRecommend(self, fromGroup, QQID, tag=None):
        ...
        if tag is None:
            ...
            try:
                ...
                CQSDK.SendGroupMsg(fromGroup, str(CQAt(QQID)) + 'զ���¶���,�������С����')
                return
        ...
        if fromGroup in groupID:
            ...
            if fromGroup == groupID[0]:
                ...
                if p < self.exProbility and self.members[fromQQ].exposionNum < maxExposionTime:
                    ...
                    if preLevel != afterLevel:
                        retMsg = str(CQAt(fromQQ)) + "�������ж���ʵ����ô���������� " + preLevel + " ������ " + afterLevel
                    else:
                        retMsg = str(CQAt(fromQQ)) + "�������ж��򣬸о���������С������"
                    try:
                        CQSDK.SendGroupMsg(fromGroup, retMsg)
                    except Exception as e:
                        logging.exception(e)
            ...
            if result:
                ...
                if cmd == '.xx' and fromGroup == groupID[0]:
                    retMsg = '�����ڵľ���Ϊ ' + self.members[fromQQ].levelName + str(CQAt(fromQQ))
                    try:
                        CQSDK.SendGroupMsg(fromGroup, retMsg)
                    except Exception as e:
                        logging.exception(e)
                    ...
                    self.save()
                    try:
                        CQSDK.SendGroupMsg(fromGroup, "���ݱ���ɹ�")
                    except Exception as e:
                        logging.exception(e)
                elif cmd == '!idol':
